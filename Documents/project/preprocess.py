from new_kmeans import spherical_kmeans
...
def preprocess(*args):
    ...
    centroids = spherical_kmeans(xZCAWhite, k=nCentroids,
                           num_iterations=50,                       
...
if __name__ == '__main__':
    ...
    with h5py.File(constants.train_packed_file, 'r') as f:
        ...
        centroids, W, M, patches, Xcont, xZCAWhite = preprocess(images, labels, sels[5])
...
#    np.testing.assert_allclose(XC1, XC2, rtol=1e-2)nnnnnnnnnnnb
